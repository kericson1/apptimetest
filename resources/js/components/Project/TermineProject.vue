          ...
          <div class="row align-items-center">
            <div class="col">
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Projets terminés</li>
              </ul>
            </div>
          </div>
        </div>
                ...
                <div class="card-body">
                  <div class="dropdown dropdown-action profile-action">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                      <router-link to="/evaluateproject" class="dropdown-item"
                        ><i class="fa fa-file m-r-5"></i>Evaluer le responsable 
                        projet</router-link
                      >
                      <router-link to="/evaluate" class="dropdown-item"
                        ><i class="fa fa-file m-r-5"></i>S'évaluer</router-link
                      >
                    </div>
                  </div>
