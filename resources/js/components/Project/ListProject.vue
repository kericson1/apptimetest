<template>
  <div class="main-wrapper">
    ...
    <div class="page-wrapper">
          ...
          <div class="row align-items-center">
            <div class="col">
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Projets en cours</li>
              </ul>
            </div>
            <div class="col-auto float-right ml-auto">
              <a
                ...
                ><i class="fa fa-plus"></i> Création de project</a
              >
            </div>
          </div>
        </div>
        ...
        <div class="row filter-row">
          <div class="col-sm-6 col-md-3">
            <div class="form-group form-focus">
              ...
              <label class="focus-label">Nom du projet</label>
            </div>
          </div>
          <div class="col-sm-6 col-md-3">
            <div class="form-group form-focus">
              <input type="text" class="form-control floating" />
              <label class="focus-label">Nom du collaborateur</label>
            </div>
          </div>
          <div class="col-sm-6 col-md-3">
            <div class="form-group form-focus select-focus">
              <select class="select floating">
                <option>Selectionnez la designation</option>
                  ...
                  <div class="dropdown dropdown-action profile-action">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                      ...
                      <a
                        ...
                        @click="getProject(projet.id_projet)"
                        ><i class="fa fa-file m-r-5"></i> Archiver projet</a
                      >
                    </div>
                  </div>
      ...
      <EditProject v-bind:projectoedit="projectoedit"></EditProject>

      <DeleteProject />

      <FileProject v-bind:projectoedit="projectoedit"></FileProject>
    </div>
  </div>
</template>
